...
//#region node_modules/.nitro/vite/services/ssr/assets/router-FVLhYvQN.js
var router_FVLhYvQN_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
function Providers({ children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(QueryClientProvider, {
		...
		children: [children, /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Toaster, {
			...
			toastOptions: { className: "!bg-card !text-foreground !border-0 !shadow-[var(--shadow-border)] !font-sans" }
		})]
	});
}
var styles_default = "/assets/styles-C26gZUQL.css";
var APP_NAME = "FREN";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "FREN is an AI desk for meme coins — live tape, scans, and a skeptical analyst."
			},
			{
				name: "theme-color",
				content: "#09090b"
...
var $$splitComponentImporter = () => import("./routes-Bm0zm6tp.mjs");
...
//#endregion
export { getRouter, router_FVLhYvQN_exports as t };
